...
def start_message(message):
    ...
    if api.check_user(message):
        ...
        bot.send_message(telegram_id, 'Вас вітає бот e-розкладу Військового інституту телекомунікацій та '
    ...
    if not user['userStatus']:
        if message_text == token_access:
            ...
            bot.send_message(telegram_id,
                             ...
                             'Ми підготували статтю, яка ознайомить Вас з основним функціоналом та принципами роботи '
                             'боту https://telegra.ph/Vas-v%D1%96taye-Telegram-bot---eSchelduleMITIT-10-29')
